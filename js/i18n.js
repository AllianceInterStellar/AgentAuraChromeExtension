const I18n = (() => {
    const translations = {
        en: {
            ...
            'options.apiUrlDesc': 'Override API endpoint for local development. Leave empty for production (awsapi.allianceinterstellar.com)',
        ...
        zh: {
            ...
            'options.apiUrlDesc': '覆盖 API 端点用于本地开发。留空使用生产环境 (awsapi.allianceinterstellar.com)',
